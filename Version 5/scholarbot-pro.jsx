...
const SCHOLARSHIP_DB = [
  {id:"4b5d219c",name:"Study.com Scholarship for African Americans",criteria:"Must be a U.S. Citizen or Permanent U.S. Resident. Must be of African American Heritage. Must be enrolled (or accepted) in an accredited college or university.",link:"https://study.com/pages/Scholarship_for_African_Americans.html",deadline:"2024-04-01",amount:"$2,000",needBased:""},
  {id:"d65e378d",name:"Jackie Robinson Foundation Scholarship",criteria:"Minority high school senior with leadership potential, SAT/ACT scores, financial need demonstrated. Must be U.S. citizen.",link:"https://www.jackierobinson.org/apply/",deadline:"2025-02-01",amount:"$30,000",needBased:"Y"},
  {id:"a91bc024",name:"Gates Scholarship",criteria:"High school seniors from minority backgrounds. Pell-eligible. Must demonstrate leadership and academic excellence. 3.3+ GPA.",link:"https://www.thegatesscholarship.org/",deadline:"2025-09-15",amount:"Full Tuition",needBased:"Y"},
  {id:"c7f3e011",name:"Ron Brown Scholar Program",criteria:"African American high school seniors. Must demonstrate academic excellence, leadership, and community service.",link:"https://www.ronbrown.org/",deadline:"2025-01-09",amount:"$40,000",needBased:""},
  {id:"e8a2d445",name:"Coca-Cola Scholars Foundation",criteria:"High school seniors with 3.0+ GPA. U.S. citizens. Leadership in school and community activities.",link:"https://www.coca-colascholarsfoundation.org/",deadline:"2025-10-31",amount:"$20,000",needBased:""},
  {id:"f12b9923",name:"Dell Scholars Program",criteria:"Must participate in an approved college readiness program. Demonstrate need for financial assistance. GPA of 2.4+. Must be a U.S. citizen or permanent resident.",link:"https://www.dellscholars.org/",deadline:"2025-12-01",amount:"$20,000",needBased:"Y"},
  {id:"b34cd881",name:"Questbridge National College Match",criteria:"High-achieving low-income students. Typically household income under $65,000. Strong academics.",link:"https://www.questbridge.org/",deadline:"2025-09-26",amount:"Full Ride",needBased:"Y"},
  {id:"19afe723",name:"Elks Most Valuable Student Scholarship",criteria:"U.S. citizen high school senior. Judged on scholarship, leadership, financial need.",link:"https://www.elks.org/scholars/scholarships/mvs.cfm",deadline:"2025-11-05",amount:"$12,500",needBased:"Y"},
  {id:"20bcd561",name:"Burger King Scholars Program",criteria:"High school seniors in U.S., Canada, or Puerto Rico. GPA 2.0+. Demonstrate financial need and work experience.",link:"https://www.burgerkingscholarship.com/",deadline:"2025-12-15",amount:"$50,000",needBased:"Y"},
  {id:"31def892",name:"Cameron Impact Scholarship",criteria:"High school seniors. Demonstrated academic achievement and community involvement. U.S. citizens.",link:"https://www.bryancameroneducationfoundation.org/",deadline:"2025-09-14",amount:"Full Tuition",needBased:""},
  {id:"42eaf123",name:"Daniels Fund Scholarship",criteria:"Graduating high school seniors from CO, NM, UT, WY. Demonstrate strength of character, leadership, community service.",link:"https://www.danielsfund.org/scholarships",deadline:"2025-11-15",amount:"Full Tuition",needBased:"Y"},
  {id:"53fba234",name:"UNCF Scholarships",criteria:"Underrepresented minority students. Multiple scholarship programs available. Must attend an HBCU or other accredited institution.",link:"https://uncf.org/scholarships",deadline:"Varies",amount:"Varies",needBased:"Y"},
  {id:"64acb345",name:"Hispanic Scholarship Fund",criteria:"Of Hispanic heritage. U.S. citizen or eligible non-citizen. Minimum 3.0 GPA. Plan to enroll full-time in college.",link:"https://www.hsf.net/scholarship",deadline:"2025-02-15",amount:"$5,000",needBased:""},
  {id:"75bdc456",name:"Asian & Pacific Islander American Scholarship",criteria:"Asian or Pacific Islander ethnicity. 3.0+ GPA. U.S. citizen or permanent resident. Financial need.",link:"https://apiascholars.org/",deadline:"2025-01-11",amount:"$20,000",needBased:"Y"},
  {id:"86ced567",name:"AXA Achievement Scholarship",criteria:"High school senior. U.S. citizen or legal resident. Demonstrate ambition and drive through outstanding achievement.",link:"https://us.axa.com/axa-foundation/AXA-achievement-scholarship.html",deadline:"2025-12-15",amount:"$25,000",needBased:""},
  {id:"97dfe678",name:"Horatio Alger Scholarship",criteria:"High school senior. Demonstrated financial need (family income under $55,000). Minimum 2.0 GPA. Involvement in activities.",link:"https://scholars.horatioalger.org/",deadline:"2025-10-25",amount:"$25,000",needBased:"Y"},
  {id:"a8ef7789",name:"Jack Kent Cooke Foundation College Scholarship",criteria:"High school senior with financial need (family income under $95,000). 3.5+ GPA. Standardized test scores.",link:"https://www.jkcf.org/our-scholarships/",deadline:"2025-11-18",amount:"$55,000",needBased:"Y"},
  {id:"b9f0889a",name:"Posse Foundation Scholarship",criteria:"Must be nominated by high school. Urban public high school students with extraordinary leadership potential.",link:"https://www.possefoundation.org/",deadline:"Nomination",amount:"Full Tuition",needBased:""},
  {id:"ca01999b",name:"Regeneron Science Talent Search",criteria:"High school seniors in the U.S. Must submit original research project in science, math, or engineering.",link:"https://www.societyforscience.org/regeneron-sts/",deadline:"2025-11-12",amount:"$250,000",needBased:""},
  {id:"db12aa0c",name:"National Merit Scholarship",criteria:"U.S. high school students. Based on PSAT/NMSQT scores. Must be enrolled full-time in college.",link:"https://www.nationalmerit.org/",deadline:"2025-10-01",amount:"$2,500",needBased:""},
  {id:"ec23bb1d",name:"Cobell Scholarship (Native American)",criteria:"Must be enrolled member of a federally recognized tribe. Undergraduate or graduate student. Financial need.",link:"https://cobellscholar.org/",deadline:"2025-01-31",amount:"$5,000",needBased:"Y"},
  {id:"fd34cc2e",name:"NAACP Scholarships",criteria:"African American students. Must be NAACP member. Varies by specific scholarship. Academic merit and financial need.",link:"https://naacp.org/find-resources/scholarships",deadline:"Varies",amount:"Varies",needBased:"Y"},
  {id:"0e45dd3f",name:"Dream.US Scholarship (DREAMers)",criteria:"DACA/TPS recipients. First-time college students or community college transfers. Financial need. 2.5+ GPA.",link:"https://www.thedream.us/",deadline:"2025-02-28",amount:"$33,000",needBased:"Y"},
  {id:"1f56ee40",name:"GE-Reagan Foundation Scholarship",criteria:"High school senior. U.S. citizen. Demonstrate leadership, drive, integrity, and citizenship. 3.0+ GPA.",link:"https://www.reaganfoundation.org/education/scholarship-programs/",deadline:"2025-01-05",amount:"$10,000",needBased:""},
  {id:"2a67ff51",name:"Foot Locker Scholar Athletes",criteria:"High school senior. 3.0+ GPA. Participate in high school sports. Strong community involvement.",link:"https://www.footlockerscholarathletes.com/",deadline:"2025-12-13",amount:"$20,000",needBased:""},
  {id:"3b780062",name:"Amazon Future Engineer Scholarship",criteria:"High school senior planning to study computer science. Financial need. Participation in STEM activities.",link:"https://www.amazonfutureengineer.com/scholarships",deadline:"2025-01-20",amount:"$40,000",needBased:"Y"},
  {id:"4c890173",name:"Buick Achievers Scholarship",criteria:"High school senior or current college student. Plan to major in STEM field. Financial need. Leadership.",link:"https://www.buickachievers.com/",deadline:"2025-02-28",amount:"$25,000",needBased:"Y"},
  {id:"5d9a0284",name:"Davidson Fellows Scholarship",criteria:"Students 18 or under. Must complete a significant project in STEM, literature, music, philosophy, or outside the box.",link:"https://www.davidsongifted.org/gifted-programs/fellows-scholarship/",deadline:"2025-02-12",amount:"$50,000",needBased:""},
  {id:"6eab1395",name:"Prudential Spirit of Community Awards",criteria:"Students in grades 5-12. Must have engaged in volunteer activity in the past year. U.S. residents.",link:"https://spirit.prudential.com/",deadline:"2025-11-08",amount:"$5,000",needBased:""},
  {id:"7fbc24a6",name:"Taco Bell Live Más Scholarship",criteria:"Ages 16-26. Must be pursuing education at accredited institution. Based on passion, not just grades.",link:"https://www.tacobellfoundation.org/live-mas-scholarship/",deadline:"2025-01-24",amount:"$25,000",needBased:""},
];
...
export default function ScholarBotPro() {
  ...
  const runMatching = useCallback(() => {
    ...
    const results = SCHOLARSHIP_DB.map(s => {
...
${Object.keys(appAnswers).length > 0 ? `\nAPPLICATION ANSWERS:\n${JSON.stringify(appAnswers)}` : ""}`
  ...
  // ============================================================
  const filteredScholarships = SCHOLARSHIP_DB.filter(s => {
          ...
          <div>
            <div style={{marginBottom:48}}>
              ...
              <p style={{fontFamily:"'DM Sans',sans-serif",fontSize:16,color:"#666",maxWidth:500,lineHeight:1.6}}>
                469 scholarships analyzed. AI-powered matching. Human-sounding application letters. Everything you need to fund your future.
              </p>
            </div>
            ...
            <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:20,marginBottom:40}}>
              {[
                {label:"Scholarships in Database",value:"469",color:"#c9a227"},
        ...
        {view === "search" && (
          <div>
            ...
            <div style={{fontSize:12,fontFamily:"'DM Sans',sans-serif",color:"#555",marginBottom:16}}>
              Showing {filteredScholarships.length} of {SCHOLARSHIP_DB.length} scholarships
            </div>
                ...
                {scholarshipInputMode === "database" && (
                  <div>
                    <select value={selectedScholarship?.id || ""} onChange={e => {
                      const s = SCHOLARSHIP_DB.find(x => x.id === e.target.value);
                      ...
                      {SCHOLARSHIP_DB.map(s => <option key={s.id} value={s.id}>{s.name} ({s.amount})</option>)}
                    </select>
